      ...
      if (d->charmap[y][x] &&
        ...
        attroff(COLOR_PAIR(d->charmap[y][x]->color));
          ...
          can_see(d,
                  ...
                  (d->obj2[y][x]->position),
                  1)) {
        attron(COLOR_PAIR(d->obj2[y][x]->color));
        mvaddch(y + 1, x, (d->obj2[y][x]->symbol));
         attroff(COLOR_PAIR(d->obj2[y][x]->color));
}
 //else if (d->map2[y][x]) //for seen map
//{
  //        attron(COLOR_PAIR(d->obj2[y][x]->color));
    //      mvaddch(y + 1, x, (d->map2[y][x]));
      //    attroff(COLOR_PAIR(d->obj2[y][x]->color));
//}
