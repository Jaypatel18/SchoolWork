...
-- Equation(s):
-- \Alarm~0_combout\ = (\Goat~combout\ & (!\Farmer~combout\ & ((\Wolf~combout\) # (\Cabbage~combout\)))) # (!\Goat~combout\ & (\Farmer~combout\ & ((!\Cabbage~combout\) # (!\Wolf~combout\))))
