...
public class Part2F 
{
	...
	public static void main(String[] args) 
	{
		...
		System.out.println("Takes approx 5 - 10 secs until the outputs are shown below for Part2F: \n");
		...
		while (t1 < limit) 
		{
			...
			{
				lst.add(rand.nextInt()); //change after run
			}
	...
	/**
	 * Using the same binary search everywhere
	 * @param allocatedsize
	 * @return
	 */
