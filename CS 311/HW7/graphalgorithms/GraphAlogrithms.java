 ...
 * 
 * @author Jay Patel
 * In this class I have Topo, allTopo and Kruskals
 * Topo: Checks the element that has the least incoming vertex, and then follows the arrow and 
 * if there is nothing pointing to the next one, marks it as visited and then goes back to the starting
 * and then choose the next unvisited and alphabetical order
 * 
 * allTopo: does exactly the same as before but this one, but choose every single element 
 * 
 * Kruskals: Choose the smallest, and check its cyclic, if not chose the next smallest and check if
 * its cyclic and do the same until the max weight
 *
 */
...
//    	
    	/**
    	 * Doing the same thing that I did in Topological with the recursive call
    	 */
...
//    			}
    ...
    /**
     * Cannot find a way to implement this. I am sorry. 
     * @param list
     * @return dummy
     */
//    private static <V,E> boolean hasCycle(List<Edge<E>> list){
//    	boolean there = false;
//    	
...
//  
    ...
    /**
     * 
     * I used this method in order to sort them first that way its easier for me 
     * see the weight 
     * @param lst
     * @return lst
     */
